...
\begin{flushright}
	\parbox{13cm}{\fontsize{10pt}In questo capitolo introduttivo vengono presentati il contesto aziendale in cui si è svolto lo stage e le premesse dello stage stesso. Infine, viene data una panoramica sul contenuto del documento.}
\end{flushright}
