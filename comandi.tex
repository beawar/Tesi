...
\usepackage[backend=bibtex,bibstyle=numeric,citestyle=verbose-trad1]{biblatex} % Use the bibtex backend with the authoryear citation style (which resembles APA)
