...
\supervisor{Prof.ssa Ombretta \textsc{Gaggi}} % Your supervisor's name, this is used in the title page, print it elsewhere with \supname
...
\author{Beatrice \textsc{Guerra}} % Your name, this is used in the title page and abstract, print it elsewhere with \authorname
...
\department{Dipartimento di Matematica Tullio Levi-Civita} % Your department's name and URL, this is used in the title page and abstract, print it elsewhere with \deptname
...
\textsc{\Large Laurea}\\[0.5cm] % Thesis type
